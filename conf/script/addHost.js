...
@parameter
   BUS_JSON: the format is: {"SdbUser":"sdbadmin","SdbPasswd":"sdbadmin","SdbUserGroup":"sdbadmin_group","InstallPacket":"/home/users/tanzhaobo/sqldb/bin/../packet/sqldb-1.8-linux_x86_64-installer.run","HostInfo":[{"IP":"192.168.20.42","HostName":"susetzb","User":"root","Passwd":"sqldb","SshPort":"22","AgentPort":"11790","InstallPath":"/opt/sqldb"},{"IP":"192.168.20.165","HostName":"rhel64-test8","User":"root","Passwd":"sqldb","SshPort":"22","AgentPort":"11790","InstallPath":"/opt/sqldb"},{"IP":"192.168.20.166","HostName":"rhel64-test9","User":"root","Passwd":"sqldb","SshPort":"22","AgentPort":"11790","InstallPath":"/opt/sqldb"}]}
   SYS_JSON: {}
   ENV_JSON: {}
   OTHER_JSON: {}
@return
...
function isMatchLocalInfo( osInfo )
{
   ...
   {
      // when no install info in /etc/default/sqldb, think it to be false
