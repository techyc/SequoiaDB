...
/** \fn INT32 sdbListBackup ( sdbConnectionHandle cHandle,
    ...
    \param [in] cHandle The connection handle
    \param [in] options Contains configuration infomations for remove backups, list all the backups in the default backup path if null. The "options" contains 3 options as below. All the elements in options are optional. eg: {"GroupName":["shardName1", "shardName2"], "Path":"/opt/sqldb/backup", "Name":"backupName"}
...
/** \fn INT32 sdbRemoveBackup ( sdbConnectionHandle cHandle,
    ...
    \param [in] cHandle The connection handle
    \param [in] options Contains configuration infomations for remove backups, remove all the backups in the default backup path if null. The "options" contains 3 options as below. All the elements in options are optional. eg: {"GroupName":["shardName1", "shardName2"], "Path":"/opt/sqldb/backup", "Name":"backupName"}
