...
/** \fn INT32 create ()
    ...
    \deprecated This function will be deprecated in SqlDB1.6, use sdbCollectionSpace::createCollection instead of it.
    \retval SDB_OK Operation Success
    \retval Others Operation Fail
*/
      INT32 create ()
...
/** \fn INT32 drop ()
    ...
    \deprecated This function will be deprecated in SqlDB1.6, use sdbCollectionSpace::dropCollection instead of it.
    \retval SDB_OK Operation Success
    \retval Others Operation Fail
*/
      INT32 drop ()
...
/** \fn INT32 create ()
    ...
    \deprecated This function will be deprecated in SqlDB2.x, use sdb::createCollectionSpace instead of it.
    \retval SDB_OK Operation Success.
    \retval Others Operation Fail
*/
      INT32 create ()
...
/** \fn INT32 drop ()
    ...
    \deprecated This function will be deprecated in SqlDB2.x, use sdb::dropCollectionSpace instead of it.
    \retval SDB_OK Operation Success
    \retval Others Operation Fail
*/
      INT32 drop ()
...
/** \fn INT32 backupOffline ( const bson::BSONObj &options)
    ...
    \param [in] options Contains a series of backup configuration infomations. Backup the whole cluster if null. The "options" contains 5 options as below. All the elements in options are optional. eg: {"GroupName":["rgName1", "rgName2"], "Path":"/opt/sqldb/backup", "Name":"backupName", "Description":description, "EnsureInc":true, "OverWrite":true}
        ...
        Path        : The backup path, if not assign, use the backup path assigned in the configuration file,
                      the path support to use wildcard(%g/%G:group name, %h/%H:host name, %s/%S:service name). e.g.  {Path:"/opt/sqldb/backup/%g"}
...
/** \fn INT32 listBackup ( sdbCursor &cursor,
    ...
    \param [in] options Contains configuration infomations for remove backups, list all the backups in the default backup path if null. The "options" contains 3 options as below. All the elements in options are optional. eg: {"GroupName":["rgame1", "rgName2"], "Path":"/opt/sqldb/backup", "Name":"backupName"}
...
/** \fn INT32 removeBackup ( const bson::BSONObj &options);
    ...
    \param [in] options Contains configuration infomations for remove backups, remove all the backups in the default backup path if null. The "options" contains 3 options as below. All the elements in options are optional. eg: {"GroupName":["rgName1", "rgName2"], "Path":"/opt/sqldb/backup", "Name":"backupName"}
