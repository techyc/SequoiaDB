...
import com.sqldb.hadoop.split.SdbBlockSplit;
...
public class SequoiadbBlockReader extends RecordReader<Object, BSONWritable> {
    ...
    private long total;
      ...
      public SequoiadbBlockReader(InputSplit inputSplit, Configuration conf){
    	...
    	this.sqldb = new Sequoiadb(this.sdbBlockSplit.getSdbAddr().getHost(), this.sdbBlockSplit.getSdbAddr().getPort(),user,passwd);
    	CollectionSpace collectionSpace=sqldb.getCollectionSpace(collectionSpaceName);
