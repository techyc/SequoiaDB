...
import com.sqldb.base.*;
import com.sqldb.core.SequoiaObjectGrabber;
import com.sqldb.core.StormSequoiaObjectGrabber;
import com.sqldb.core.UpdateQueryCreator;
import com.sqldb.spout.SequoiaCappedCollectionSpout;
import com.sqldb.bolt.SequoiaUpdateBolt;
...
public class EnronEmailWordCounts {
	...
	public static void main(String[] args) throws UnknownHostException {
		try {
			...
			builder.setSpout("sqldbspout", spout, 1);
			builder.setBolt("wordscount", wordCountingBolt, 20)
					.shuffleGrouping("sqldbspout");
			builder.setBolt("sqldbbolt", mongoUpdateBolt, 10)
