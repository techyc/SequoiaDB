...
const zend_function_entry sqldb_sdb_functions[] = {
   PHP_ME ( SqlDB, __construct     , NULL, ZEND_ACC_PUBLIC )
   PHP_ME ( SqlDB, __destruct      , NULL, ZEND_ACC_PUBLIC )
   PHP_ME ( SqlDB, install         , NULL, ZEND_ACC_PUBLIC )
   PHP_ME ( SqlDB, getError        , NULL, ZEND_ACC_PUBLIC )
   PHP_ME ( SqlDB, connect         , NULL, ZEND_ACC_PUBLIC )
   PHP_ME ( SqlDB, close           , NULL, ZEND_ACC_PUBLIC )
   PHP_ME ( SqlDB, getSnapshot     , NULL, ZEND_ACC_PUBLIC )
   PHP_ME ( SqlDB, getList         , NULL, ZEND_ACC_PUBLIC )
   PHP_ME ( SqlDB, resetSnapshot   , NULL, ZEND_ACC_PUBLIC )
   PHP_ME ( SqlDB, selectCS        , NULL, ZEND_ACC_PUBLIC )
   PHP_ME ( SqlDB, listCSs         , NULL, ZEND_ACC_PUBLIC )
   PHP_ME ( SqlDB, listCollections , NULL, ZEND_ACC_PUBLIC )
   PHP_ME ( SqlDB, selectGroup     , NULL, ZEND_ACC_PUBLIC )
   PHP_ME ( SqlDB, execSQL         , NULL, ZEND_ACC_PUBLIC )
   PHP_ME ( SqlDB, execUpdateSQL   , NULL, ZEND_ACC_PUBLIC )
   PHP_ME ( SqlDB, createCataGroup , NULL, ZEND_ACC_PUBLIC )
   PHP_ME ( SqlDB, dropCollectionSpace , NULL, ZEND_ACC_PUBLIC )
   PHP_ME ( SqlDB, createDomain    , NULL, ZEND_ACC_PUBLIC )
   PHP_ME ( SqlDB, dropDomain      , NULL, ZEND_ACC_PUBLIC )
   PHP_ME ( SqlDB, getDomain       , NULL, ZEND_ACC_PUBLIC )
   PHP_ME ( SqlDB, listDomains     , NULL, ZEND_ACC_PUBLIC )
   PHP_FE_END
};

const zend_function_entry sqldb_cs_functions[] = {
...
const zend_function_entry sqldb_collection_functions[] = {
...
const zend_function_entry sqldb_cursor_functions[] = {
...
const zend_function_entry sqldb_domain_functions[] = {
...
zend_module_entry sqldb_module_entry = {
...
ZEND_GET_MODULE(sqldb)
#endif

PHP_MINIT_FUNCTION(sqldb)
{
   zend_class_entry sqldbSdb ;
   zend_class_entry sqldbCollectionSpace ;
   zend_class_entry sqldbCollection ;
   zend_class_entry sqldbCursor ;
   zend_class_entry sequoiaDomain ;
   zend_class_entry sqldbID ;
   zend_class_entry sqldbDate ;
   zend_class_entry sqldbTimeStamp ;
   zend_class_entry sequoiaRegex ;
   zend_class_entry sequoiaINT64 ;
   zend_class_entry sequoiaGroup ;
   zend_class_entry sequoiaNode ;

   INIT_CLASS_ENTRY ( sqldbSdb, "SqlDB", sqldb_sdb_functions ) ;
   INIT_CLASS_ENTRY ( sqldbCollectionSpace,
                      "SequoiaCS",sqldb_cs_functions  ) ;
   INIT_CLASS_ENTRY ( sqldbCollection,
                      "SequoiaCL",
                      sqldb_collection_functions  ) ;
   INIT_CLASS_ENTRY ( sqldbCursor,
                      "SequoiaCursor", sqldb_cursor_functions  ) ;
   INIT_CLASS_ENTRY ( sequoiaDomain,
                      "SequoiaDomain", sqldb_domain_functions  ) ;
   INIT_CLASS_ENTRY ( sqldbID, "SequoiaID", sequoia_id_functions  ) ;
   INIT_CLASS_ENTRY ( sqldbDate, "SequoiaDate", sequoia_date_functions  ) ;
   INIT_CLASS_ENTRY ( sqldbTimeStamp,
   ...
   pSequoiadbSdb             =
zend_register_internal_class( &sqldbSdb TSRMLS_CC ) ;
   pSequoiadbCollectionSpace =
zend_register_internal_class( &sqldbCollectionSpace TSRMLS_CC ) ;
   pSequoiadbCollection      =
zend_register_internal_class( &sqldbCollection TSRMLS_CC ) ;
   pSequoiadbCursor          =
zend_register_internal_class( &sqldbCursor TSRMLS_CC ) ;
   pSequoiadbDomain          =
zend_register_internal_class( &sequoiaDomain TSRMLS_CC ) ;
   pSequoiadbId              =
zend_register_internal_class( &sqldbID TSRMLS_CC ) ;
   pSequoiadbData            =
zend_register_internal_class( &sqldbDate TSRMLS_CC ) ;
   pSequoiadbTimeStamp       =
zend_register_internal_class( &sqldbTimeStamp TSRMLS_CC ) ;
   pSequoiadbRegex           =
...
PHP_MINFO_FUNCTION(sqldb)
{
   ...
   php_info_print_table_header(2, "sqldb support", "enabled");
...
/* {{{ proto string confirm_sqldb_compiled(string arg)
