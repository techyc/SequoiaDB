...
"""Module of replicagroup for python driver of SqlDB
"""
...
class replicagroup(object):
   ...
   def __del__(self):
      ...
      if self._group is not None:
         try:
            ...
            pysqldb._raise_if_error("Failed to release replica group", rc)
         except SDBBaseError:
            raise
         self._group = None
   ...
   def get_nodenum(self, nodestatus):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to get count of node", rc)
      except SDBBaseError:
          nodenum = 0
          raise
   ...
   def get_detail(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to get detail", rc)
      except SDBBaseError:
         detail=None
         raise
   ...
   def get_master(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to get master", rc)
      except SDBBaseError:
         del node
         node = None
         raise
   ...
   def get_slave(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to get slave", rc)
      except SDBBaseError:
         del node
         node = None
         raise
   ...
   def get_nodebyendpoint(self, hostname, servicename):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to get node", rc)
      except SDBBaseError:
         del node
         node = None
         raise
   ...
   def create_node(self, hostname, servicename, dbpath, config = None):
      ...
      try:
         rc = sdb.gp_create_node(self._group, hostname, servicename,
                                          dbpath, config)
         pysqldb._raise_if_error("Failed to create node", rc)
      except SDBBaseError:
         raise
   ...
   def remove_node(self, hostname, servicename, config = None):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to remove node", rc)
      except SDBBaseError:
         raise
   ...
   def start(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to start", rc)
      except SDBBaseError:
         raise
   ...
   def stop(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to stop", rc)
      except SDBBaseError:
         raise
   ...
   def is_catalog(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to get catalog info", rc)
      except SDBBaseError:
         raise
