...
"""Module of collectionspace for python driver of SqlDB
"""
...
class collectionspace(object):
   ...
   def __del__(self):
      ...
      if self._cs is not None:
         try:
            ...
            pysqldb._raise_if_error("Failed to release collection space",
                                        rc)
         except SDBBaseError:
            raise
         self._cs = None
   ...
   def __getattr__(self, name):
      ...
      if '__members__' == name or '__methods__' == name:
         ...
         try:
            ...
            pysqldb._raise_if_error("Failed to get collection: %s" %
                                        name, rc)
         except SDBBaseError:
            del cl;
            cl = None
      ...
      try:
         ...
         if bson_options is None:
            ...
            rc = sdb.cs_create_collection_use_opt(self._cs, cl_name,
                                                 bson_options, cl._cl)
         pysqldb._raise_if_error("Failed to create collection", rc)
      except SDBBaseError:
         del cl
         cl = None
         raise
   ...
   def drop_collection(self, cl_name):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to drop collection", rc)
      except SDBBaseError:
         raise
