...
"""Module of client for python driver of SqlDB
...
import bson
import pysqldb
from pysqldb.collectionspace import collectionspace
from pysqldb.collection import collection
from pysqldb.cursor import cursor
from pysqldb.replicagroup import replicagroup
from pysqldb.common import const
from pysqldb.error import (SDBBaseError, SDBTypeError)


class client(object):
   """SqlDB Client Driver
   
   The client support interfaces to connect to SqlDB.
   In order to connect to SqlDB, you need use the class first.
   ...
   def __init__(self, host = None, service = None, user = None, psw  = None):
      """initialize when product a object.
         ...
         it will try to connect to SqlDB using host and port given,
      ...
      Parameters:
         ...
         psw     str       The user password to access to database,
                                 if None, "" will be insteaded
      Exceptions:
         pysqldb.error.SDBTypeError
         pysqldb.error.SDBBaseError
      """
   ...
   def __del__(self):
      ...
      if self._client is not None:
         try:
            ...
            pysqldb._raise_if_error("Failed to release client", rc)
         except SDBBaseError:
            raise
         self._client = None
   ...
   def __getattr__(self, name):
      ...
      if '__members__' == name or '__methods__' == name:
         ...
         try:
            ...
            pysqldb._raise_if_error("Failed to get collection space: %s" %
                                        name, rc)
         except SDBBaseError:
            del cs;
            cs = None
   ...
   def connect(self, host, service, **kwargs):
      ...
      try:
         rc = sdb.sdb_connect(self._client, self.__host, self.__service,
                                              _user, _psw)
         pysqldb._raise_if_error("Failed to connect to %s:%s" %
   ...
   def disconnect(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to release object", rc)
      except SDBBaseError:
         raise
   ...
   def create_user(self, name, psw):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to create user", rc)
      except SDBBaseError:
         raise
   ...
   def remove_user(self, name, psw):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to remove user", rc)
      except SDBBaseError:
         raise
   ...
   def get_snapshot(self, snap_type, **kwargs):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to get snapshot", rc)
      except SDBBaseError:
         del result
         result = None
         raise
   ...
   def reset_snapshot(self, condition = None):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to reset snapshot", rc)
      except SDBBaseError:
         raise
   ...
   def get_list(self, list_type, **kwargs):
      ...
      try:
         ...
         rc = sdb.sdb_get_list(self._client, result._cursor, list_type,
                                 bson_condition, bson_selector, bson_order_by)
         pysqldb._raise_if_error("Failed to get list", rc)
      except SDBBaseError:
         del result
         result = None
         raise
   ...
   def get_collection(self, cl_full_name):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to get collection", rc)
      except SDBBaseError:
         del cl
         cl = None
         raise
   ...
   def get_collection_space(self, cs_name):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to get collection space", rc)
      except SDBBaseError:
         del cs
         cs = None
         raise
   ...
   def create_collection_space(self, cs_name, page_size = 0):
      ...
      try:
         ...
         rc = sdb.sdb_create_collection_space(self._client, cs_name,
                                                page_size, cs._cs)
         pysqldb._raise_if_error("Failed to create collection space", rc)
      except SDBBaseError:
         del cs
         cs = None
         raise
   ...
   def drop_collection_space(self, cs_name):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to drop collection space", rc)
      except SDBBaseError:
         raise
   ...
   def list_collection_spaces(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to list collection spaces", rc)
      except SDBBaseError:
         del result
         result = None
         raise
   ...
   def list_collections(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to list collections", rc)
      except SDBBaseError:
         del result
         result = None
         raise
   ...
   def list_replica_groups(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to list replica groups", rc)
      except SDBBaseError:
         del result
         result = None
         raise
   ...
   def get_replica_group_by_name(self, group_name):
      ...
      try:
         ...
         rc = sdb.sdb_get_replica_group_by_name(self._client, group_name,
                                                  result._group)
         pysqldb._raise_if_error("Failed to get specified group", rc)
      except SDBBaseError:
         del result
         result = None
         raise
   ...
   def create_replica_group(self, group_name):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to create replica group", rc)
      except SDBBaseError:
         del replica_group
         replica_group = None
         raise
   ...
   def remove_replica_group(self, group_name):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to remove replica group", rc)
      except SDBBaseError:
         raise
   ...
   def create_replica_cata_group(self, host, service, path, configure):
      ...
      try:
         rc = sdb.sdb_create_replica_cata_group(self._client, host, service,
                                                  path, bson_configure)
         pysqldb._raise_if_error("Failed to create replica cate group", rc)
      except SDBBaseError:
         raise
   ...
   def exec_update(self, sql):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to execute update sql", rc)
      except SDBBaseError:
         raise
   ...
   def exec_sql(self, sql):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to execute sql command", rc)
      except SDBBaseError:
         del result
         result = None
         raise
   ...
   def transaction_begin(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Transaction error", rc)
      except SDBBaseError:
         raise
   ...
   def transaction_commit(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Transaction commit error", rc)
      except SDBBaseError:
         raise
   ...
   def transaction_rollback(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Transaction rollback error", rc)
      except SDBBaseError:
         raise
   ...
   def flush_configure(self, options):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to flush confige", rc)
      except SDBBaseError:
         raise
   ...
   def create_procedure(self, code):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to crate procedure", rc)
      except SDBBaseError:
         raise
   ...
   def remove_procedure(self, name):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to remove procedure", rc)
      except SDBBaseError:
         raise
   ...
   def list_procedures(self, condition):
      ...
      try:
         ...
         rc = sdb.sdb_list_procedures(self._client, result._cursor,
                                        bson_condition)
         pysqldb._raise_if_error("Failed to list procedures", rc)
      except SDBBaseError:
         del result
         result = None
         raise
   ...
   def eval_procedure(self, name):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to eval procedure", rc)
      except SDBBaseError:
         del result
         result = None
         raise
   ...
   def backup_offline(self, options = None):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to backup offline", rc)
      except SDBBaseError:
         raise
   ...
   def list_backup(self, options, **kwargs):
      ...
      try:
         ...
         rc = sdb.sdb_list_backup(self._client, result._cursor, bson_options,
                                   bson_condition, bson_selector, bson_order_by)
         pysqldb._raise_if_error("Failed to list backup", rc)
      except SDBBaseError:
         del result
         result = None
         raise
   ...
   def remove_backup(self, options):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to remove backup", rc)
      except SDBBaseError:
         raise
   ...
   def list_task(self, **kwargs):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to list tasks", rc)
      except SDBBaseError:
         del result
         result = None
         raise
   ...
   def wait_task(self, task_ids, num):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to wait task", rc)
      except SDBBaseError:
         raise
   ...
   def cancel_task(self, task_id, is_async):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to cancel task", rc)
      except SDBBaseError:
         raise
   ...
   def set_session_attri(self, options = None):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to set session attribute", rc)
      except SDBBaseError:
         raise
   ...
   def close_all_cursors(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to close all cursors", rc)
      except SDBBaseError:
         raise
   ...
   def is_valid(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("connection is invalid", rc)
      except SDBBaseError:
         valid = False
         raise
