...
class SDBBaseError(Exception):
   """Base Exception of Python Driver for SqlDB
   """
...
class SDBError(SDBBaseError):
   """Gerneral Error of SqlDB
   """
   def __init__(self, errmsg, code):
      SDBBaseError.__init__(self, errmsg, code, "SqlDB Error")
