...
from pysqldb.error import (SDBBaseError, SDBEndOfCursor)
...
class cursor(object):
   ...
   def __del__(self):
      ...
      if self._cursor is not None:
         try:
            ...
            pysqldb._raise_if_error("Failed to release cursor", rc)
         except SDBBaseError:
            raise
         self._cursor = None
   ...
   def close(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to close cursor", rc)
      except SDBBaseError:
         raise
