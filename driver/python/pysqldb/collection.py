...
"""Module of collection for python driver of SqlDB
"""
...
from pysqldb.lob import lob
from pysqldb import error
from pysqldb.common import const
from pysqldb.error import (SDBBaseError,
                               SDBTypeError,
                               SDBSystemError,
                               SDBEndOfCursor)

class collection(object):
   """Collection for SqlDB
   ...
   def __del__(self):
      ...
      if self._cl is not None:
         try:
            ...
            pysqldb._raise_if_error("Failed to release collection", rc)
         except SDBBaseError:
            raise
   ...
   def get_count(self, condition = None):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to get count of record", rc)
      except SDBBaseError:
         count = 0
         raise
   ...
   def split_by_condition(self, source_group_name, target_group_name,
      ...
      try:
         rc = sdb.cl_split_by_condition(self._cl, source_group_name,
                                                 ...
                                                 bson_end_condition)
         pysqldb._raise_if_error("Failed to split", rc)
      except SDBBaseError:
         raise
   ...
   def split_by_percent(self, source_group_name, target_group_name, percent):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to split by precent", rc)
      except SDBBaseError:
         raise
   ...
   def split_async_by_condition(self, source_group_name, target_group_name,
      ...
      try:
         rc, task_id = sdb.cl_split_async_by_condition(self._cl,
                                                      ...
                                                      bson_split_condition,
                                                      bson_end_condition)
         pysqldb._raise_if_error("Failed to split async", rc)
   ...
   def bulk_insert(self, flags, records):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to insert records", rc)
      except SDBBaseError:
         raise
   ...
   def insert(self, record):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to insert record", rc)
      except SDBBaseError:
         raise
   ...
   def update(self, rule, **kwargs):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to update", rc)
      except SDBBaseError:
         raise
   ...
   def delete(self, **kwargs):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to delete", rc)
      except SDBBaseError:
         raise
   ...
   def query(self, **kwargs):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to query", rc)
      except SDBBaseError:
         del result
         result = None
         raise
   ...
   def create_index(self, index_def, idx_name, is_unique, is_enforced):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to create index", rc)
      except SDBBaseError:
         raise
   ...
   def get_indexes(self, idx_name = None):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to get indexes", rc)
      except SDBBaseError:
         del result
         result = None
         raise
   ...
   def drop_index(self, idx_name):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to drop index", rc)
      except SDBBaseError:
         raise
   ...
   def get_collection_name(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to get collection name", rc)
      except SDBBaseError:
         raise
   ...
   def get_cs_name(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to get collection space name", rc)
      except SDBBaseError:
         raise
   ...
   def get_full_name(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to get full name", rc)
      except SDBBaseError:
         raise
   ...
   def aggregate(self, aggregate_options):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to aggregate", rc)
      except SDBBaseError:
         del result
         result = None
         raise
   ...
   def get_query_meta(self, **kwargs):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to query meta", rc)
      except SDBBaseError:
         del result
         result = None
         raise
   ...
   def attach_collection(self, cl_full_name, options):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to attach collection", rc)
      except SDBBaseError:
         raise
   ...
   def detach_collection(self, sub_cl_full_name):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to detach collection", rc)
      except SDBBaseError:
         raise
   ...
   def create_lob(self, oid = None):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to create lob", rc)
      except SDBBaseError:
         raise
   ...
   def get_lob(self, oid):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to get specified lob", rc)
      except SDBBaseError:
         raise
   ...
   def remove_lob(self, oid):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to remove lob", rc)
      except SDBBaseError:
         raise
   ...
   def list_lobs(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to list lobs", rc)
      except SDBBaseError:
         del result
         result = None
         raise
   ...
   def query_one(self, **kwargs):
      ...
      try:
         ...
         rc = sdb.cl_query(self._cl, result._cursor,
                          ...
                          bson_order_by, bson_hint,
                          num_to_skip, 1L)
         pysqldb._raise_if_error("Failed to query one", rc)
      except SDBBaseError:
         del result
         result = None
         raise
   ...
   def explain(self, **kwargs):
      ...
      try:
         ...
         rc = sdb.cl_explain(self._cl, result._cursor,
                             ...
                             num_to_skip, num_to_return,
                             flag, bson_options)
         pysqldb._raise_if_error("Failed to explain", rc)
      except SDBBaseError:
         del result
         result = None
         raise
