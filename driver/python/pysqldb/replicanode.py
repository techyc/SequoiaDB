...
"""Module of replicanode for python driver of SqlDB
"""
...
class replicanode(object):
   ...
   def __del__(self):
      ...
      if self._node is not None:
         try:
            ...
            pysqldb._raise_if_error("Failed to release node", rc)
         except SDBBaseError:
            raise
         self._node = None
      self._client = None
   ...
   def connect(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to connect", rc)
      except SDBBaseError:
         raise
   ...
   def get_status(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to get node status", rc)
      except SDBBaseError:
          raise
   ...
   def get_hostname(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to get host name", rc)
      except SDBBaseError:
         hostname = None
         raise
   ...
   def get_servicename(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to get service name", rc)
      except SDBBaseError:
         servicename = None
         raise
   ...
   def get_nodename(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to get node name", rc)
      except SDBBaseError:
         nodename = None
         raise
   ...
   def stop(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to stop node", rc)
      except SDBBaseError:
         raise
   ...
   def start(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Filed to start node", rc)
      except SDBBaseError:
         raise
