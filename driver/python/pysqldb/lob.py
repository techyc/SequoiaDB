...
from pysqldb.error import (SDBBaseError, SDBTypeError, SDBSystemError,
                               InvalidParameter)
...
class lob(object):
   ...
   def __del__(self) :
      if self._handle is not None:
         try:
            ...
            pysqldb._raise_if_error("Failed to release lob", rc)
         except SDBBaseError:
            raise
         self._handle = None
   ...
   def close(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to close lob", rc)
      except SDBBaseError:
         raise
   ...
   def get_size(self) :
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to get size of lob", rc)
      except SDBBaseError:
         raise
      return size
   ...
   def get_oid(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to get oid of lob", rc)
      except SDBBaseError :
         raise
   ...
   def get_create_time(self):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to get createtime of lob", rc)
      except SDBBaseError:
         raise
   ...
   def seek(self, seek_pos, whence = 0) :
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to seek lob", rc)
      except SDBBaseError:
         raise
   ...
   def read(self, len):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to read data from lob", rc)
      except SDBBaseError:
         raise
      return data
   ...
   def write(self, data, len):
      ...
      try:
         ...
         pysqldb._raise_if_error("Failed to write data to lob", rc)
      except SDBBaseError:
         raise
