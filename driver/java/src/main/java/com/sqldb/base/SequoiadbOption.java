...
public class SequoiadbOption
{
     ...
     * @exception com.sqldb.exception.BaseException when maxConnectionNum is negative
	 */
     ...
     * @exception com.sqldb.exception.BaseException when deltaIncCount is negative
	 */
     ...
     * @exception com.sqldb.exception.BaseException when initConnectionNum is negative
	 */
     ...
     * @exception com.sqldb.exception.BaseException when maxIdeNum is negative
	 */
    ...
    * @exception com.sqldb.exception.BaseException when recheckCyclePeriod is negative
    ...
    * @exception com.sqldb.exception.BaseException when timeout is negative
    */
	 ...
	 * @exception com.sqldb.exception.BaseException when abandonTime is negative
