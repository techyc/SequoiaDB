...
public class ConnectionTCPImpl implements IConnection {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.sqldb.net.IConnection#changeConfigOptions(com.sqldb.net.
	 * ConfigOptions)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.sqldb.net.IConnection#receiveMessage()
	 */
...
*/			
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.sqldb.net.IConnection#initialize()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.sqldb.net.IConnection#sendMessage(byte[], int)
	 */
